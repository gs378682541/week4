MoviesApp::Application.routes.draw do
  ...
  put '/theaters/:id', controller: 'theaters', action: 'update', as: 'update'
  post '/theaters', controller: 'theaters', action: 'create', as: 'create'
  delete '/theaters/:id', controller: 'theaters', action: 'destroy', as: 'destroy'
end
